...
var player
var lives : int = 3 
var color: Array = ["blue", "grey", "orange", "vamp"]

###START LEVEL ENVIRONMENTS
#Multiple environments (Level Selector) array
enum Environments {
	DEFAULT,
	BEACH,
	GREEN,
...
var tilesets = {
	Environments.DEFAULT: preload("res://Resources(Tilemap potential)/Level_TileSet.tres"),
	Environments.BEACH: preload("res://Resources(Tilemap potential)/Level_TileSet_Beach.tres"),
	Environments.GREEN: preload("res://Resources(Tilemap potential)/Level_TileSet_Green.tres"),
	
}
#### END OF LEVEL ENVIRONMENTS

var current_environment = Environments.DEFAULT
